...
try:
    ...
    logger2 = create_voidp(lambda fn: libmetawear.mbl_mw_datasignal_log(signal, None, fn), resource="acc_logger")
    ...
    libmetawear.mbl_mw_logger_subscribe(logger2, None, callback)
